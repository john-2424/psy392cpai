...
\begin{frame}{Zero-shot: who generalizes?}
  ...
  \begin{itemize}\setlength\itemsep{0.05em}
    ...
    \item Replay strong on \texttt{stable}, \texttt{transition}, \texttt{obs\_visual}; floor on \texttt{reward\_change}, \texttt{obs\_remap}.
    \item SR at or near floor on everything -- the $(1,1)\rightarrow(1,6)$ goal column tie sets up what comes next.
  \end{itemize}
\end{frame}
